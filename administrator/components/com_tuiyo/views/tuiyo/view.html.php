    ...
    public function display($tpl = null, $tabgroup = "", $tabactive="") {
        ...
        $defaultTabGroup = array(
            "_default" => array(
                ...
                _("Recent Activity") => "&action=recent",
        ...
        switch ($action):
            ...
            default:
                ...
                $TMPL->addJS(TUIYO_JS . '/includes/flot/flot.js');
                $TMPL->addJS(TUIYO_JS . '/includes/flot/flot.selection.js');
                ...
                $tmplVars["charts"] = $TMPL->parseTmpl("charts", $tmplPath, $tmplVars);
