 ...
 */
class BeboServiceController Extends TuiyoControllerServices{
	
	/**
	 * Feed Service for Tuiyo 
	 * @var object
	 */
	public function __construct(){
		
		//SET MODEL/VIEW PATH
		$this->_setPath('view', TUIYO_PLUGINS.DS.'bebo'.DS.'views');
		$this->addModelPath(TUIYO_PLUGINS.DS.'bebo'.DS.'models');
	...
	public function remove(){
		...
		$model		= &$this->getModel("bebo" );
		$view		= &$this->getView("bebo", "json");
		...
		if($model->removeService( "bebo", $user->id) ){
	 		$resp = array(
				"code" 	=> TUIYO_OK, 
				"error" => null, 
	 		);
