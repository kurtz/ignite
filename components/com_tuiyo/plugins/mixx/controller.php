 ...
 */
class MixxServiceController Extends TuiyoControllerServices{
	
public function __construct(){
		
		//SET MODEL/VIEW PATH
		$this->_setPath('view', TUIYO_PLUGINS.DS.'mixx'.DS.'views');
		$this->addModelPath(TUIYO_PLUGINS.DS.'mixx'.DS.'models');
	...
	public function remove(){
		...
		$model		= &$this->getModel("mixx" );
		$view		= &$this->getView("mixx", "json");
		...
		if($model->removeService( "mixx", $user->id) ){
	 		$resp = array(
				"code" 	=> TUIYO_OK, 
				"error" => null, 
	 		);
