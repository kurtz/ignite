 ...
 */
class iLikeServiceController Extends TuiyoControllerServices{
	
	public function __construct(){
		
		//SET MODEL/VIEW PATH
		$this->_setPath('view', TUIYO_PLUGINS.DS.'ilike'.DS.'views');
		$this->addModelPath(TUIYO_PLUGINS.DS.'ilike'.DS.'models');
	...
	public function remove(){
		...
		$model		= &$this->getModel("ilike" );
		$view		= &$this->getView("ilike", "json");
		...
		if($model->removeService( "ilike", $user->id) ){
	 		$resp = array(
				"code" 	=> TUIYO_OK, 
				"error" => null, 
	 		);
