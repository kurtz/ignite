 ...
 */
class DribbbleServiceController Extends TuiyoControllerServices{
	
	public function __construct(){
		
		//SET MODEL/VIEW PATH
		$this->_setPath('view', TUIYO_PLUGINS.DS.'dribbble'.DS.'views');
		$this->addModelPath(TUIYO_PLUGINS.DS.'dribbble'.DS.'models');
	...
	public function remove(){
		...
		$model		= &$this->getModel("dribbble" );
		$view		= &$this->getView("dribbble", "json");
		...
		if($model->removeService( "dribbble", $user->id) ){
	 		$resp = array(
				"code" 	=> TUIYO_OK, 
				"error" => null, 
	 		);
