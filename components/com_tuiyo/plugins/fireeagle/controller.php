 ...
 */
class FireeagleServiceController Extends TuiyoControllerServices{
	
public function __construct(){
		
		//SET MODEL/VIEW PATH
		$this->_setPath('view', TUIYO_PLUGINS.DS.'fireeagle'.DS.'views');
		$this->addModelPath(TUIYO_PLUGINS.DS.'fireeagle'.DS.'models');
	...
	public function remove(){
		...
		if($model->removeService( "fireeagle", $user->id) ){
	 		$resp = array(
				"code" 	=> TUIYO_OK, 
				"error" => null, 
	 		);
