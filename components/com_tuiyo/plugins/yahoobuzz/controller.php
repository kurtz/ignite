...
/**
 * 
 * YahooBuzz Controller.
 * @author livingstonefultang
 */
class YahooBuzzServiceController Extends TuiyoControllerServices{
	
	public function __construct(){
		
		//SET MODEL/VIEW PATH
		$this->_setPath('view', TUIYO_PLUGINS.DS.'yahoobuzz'.DS.'views');
		$this->addModelPath(TUIYO_PLUGINS.DS.'yahoobuzz'.DS.'models');
	...
	public function remove(){
		...
		$model		= &$this->getModel("yahoobuzz" );
		$view		= &$this->getView("yahoobuzz", "json");
		...
		if($model->removeService( "yahoobuzz", $user->id) ){
	 		$resp = array(
				"code" 	=> TUIYO_OK, 
				"error" => null, 
	 		);
