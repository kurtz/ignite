...
/**
 * 
 * Delicious Controller.
 * @author livingstonefultang
 */
class DeliciousServiceController Extends TuiyoControllerServices{
	
	public function __construct(){
		
		//SET MODEL/VIEW PATH
		$this->_setPath('view', TUIYO_PLUGINS.DS.'delicious'.DS.'views');
		$this->addModelPath(TUIYO_PLUGINS.DS.'delicious'.DS.'models');
	...
	public function remove(){
		...
		$model		= &$this->getModel("delicious" );
		$view		= &$this->getView("delicious", "json");
		...
		if($model->removeService( "delicious", $user->id) ){
	 		$resp = array(
				"code" 	=> TUIYO_OK, 
				"error" => null, 
	 		);
