 ...
 */
class GeotagServiceController Extends TuiyoControllerServices{
	
	public function __construct(){
		
		//SET MODEL/VIEW PATH
		$this->_setPath('view', TUIYO_PLUGINS.DS.'geotag'.DS.'views');
		$this->addModelPath(TUIYO_PLUGINS.DS.'geotag'.DS.'models');
	...
	public function remove(){
		...
		$model		= &$this->getModel("geotag" );
		$view		= &$this->getView("geotag", "json");
		...
		if($model->removeService( "geotag", $user->id) ){
	 		$resp = array(
				"code" 	=> TUIYO_OK, 
				"error" => null, 
	 		);
