 ...
 */
class FoursquareServiceController Extends TuiyoControllerServices{
	
public function __construct(){
		
		//SET MODEL/VIEW PATH
		$this->_setPath('view', TUIYO_PLUGINS.DS.'foursquare'.DS.'views');
		$this->addModelPath(TUIYO_PLUGINS.DS.'foursquare'.DS.'models');
	...
	public function remove(){
		...
		$model		= &$this->getModel("foursquare" );
		$view		= &$this->getView("foursquare", "json");
		...
		if($model->removeService( "foursquare", $user->id) ){
	 		$resp = array(
				"code" 	=> TUIYO_OK, 
				"error" => null, 
	 		);
