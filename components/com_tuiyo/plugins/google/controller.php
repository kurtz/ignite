 ...
 */
class GoogleServiceController Extends TuiyoControllerServices{
	
	public function __construct(){
		
		//SET MODEL/VIEW PATH
		$this->_setPath('view', TUIYO_PLUGINS.DS.'google'.DS.'views');
		$this->addModelPath(TUIYO_PLUGINS.DS.'google'.DS.'models');
	...
	public function remove(){
		...
		if($model->removeService( "google", $user->id) ){
	 		$resp = array(
				"code" 	=> TUIYO_OK, 
				"error" => null, 
	 		);
