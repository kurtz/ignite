 ...
 */
class TumblrServiceController Extends TuiyoControllerServices{
	
	public function __construct(){
		
		//SET MODEL/VIEW PATH
		$this->_setPath('view', TUIYO_PLUGINS.DS.'tumblr'.DS.'views');
		$this->addModelPath(TUIYO_PLUGINS.DS.'tumblr'.DS.'models');
	...
	public function remove(){
		...
		$model		= &$this->getModel("tumblr" );
		$view		= &$this->getView("tumblr", "json");
		...
		if($model->removeService( "tumblr", $user->id) ){
	 		$resp = array(
				"code" 	=> TUIYO_OK, 
				"error" => null, 
	 		);
