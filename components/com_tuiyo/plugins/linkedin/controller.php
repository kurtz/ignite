 ...
 */
class LinkedInServiceController Extends TuiyoControllerServices{
	
	public function __construct(){
		
		//SET MODEL/VIEW PATH
		$this->_setPath('view', TUIYO_PLUGINS.DS.'linkedin'.DS.'views');
		$this->addModelPath(TUIYO_PLUGINS.DS.'linkedin'.DS.'models');
	...
	public function remove(){
		...
		$view		= &$this->getView("linkedin", "json");
		...
		if($model->removeService( "linkedin", $user->id) ){
	 		$resp = array(
				"code" 	=> TUIYO_OK, 
				"error" => null, 
	 		);
