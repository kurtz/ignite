 ...
 */
class SpotifyServiceController Extends TuiyoControllerServices{
	
	public function __construct(){
		
		//SET MODEL/VIEW PATH
		$this->_setPath('view', TUIYO_PLUGINS.DS.'spotify'.DS.'views');
		$this->addModelPath(TUIYO_PLUGINS.DS.'spotify'.DS.'models');
	...
	public function remove(){
		...
		$model		= &$this->getModel("spotify" );
		$view		= &$this->getView("spotify", "json");
		...
		if($model->removeService( "spotify", $user->id) ){
	 		$resp = array(
				"code" 	=> TUIYO_OK, 
				"error" => null, 
	 		);
