 ...
 */
class SlideshareServiceController Extends TuiyoControllerServices{
	
	public function __construct(){
		
		//SET MODEL/VIEW PATH
		$this->_setPath('view', TUIYO_PLUGINS.DS.'slideshare'.DS.'views');
		$this->addModelPath(TUIYO_PLUGINS.DS.'slideshare'.DS.'models');
	...
	public function remove(){
		...
		$model		= &$this->getModel("slideshare" );
		$view		= &$this->getView("slideshare", "json");
		...
		if($model->removeService( "slideshare", $user->id) ){
	 		$resp = array(
				"code" 	=> TUIYO_OK, 
				"error" => null, 
	 		);
