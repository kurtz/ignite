 ...
 */
class GowallaServiceController Extends TuiyoControllerServices{
	
	public function __construct(){
		
		//SET MODEL/VIEW PATH
		$this->_setPath('view', TUIYO_PLUGINS.DS.'gowalla'.DS.'views');
		$this->addModelPath(TUIYO_PLUGINS.DS.'gowalla'.DS.'models');
	...
	public function remove(){
		...
		$model		= &$this->getModel("gowalla" );
		$view		= &$this->getView("gowalla", "json");
		...
		if($model->removeService( "gowalla", $user->id) ){
	 		$resp = array(
				"code" 	=> TUIYO_OK, 
				"error" => null, 
	 		);
