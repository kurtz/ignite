...
/**
 * 
 *Readernaut Controller.
 * @author livingstonefultang
 */
class ReadernautServiceController Extends TuiyoControllerServices{
	
public function __construct(){
		
		//SET MODEL/VIEW PATH
		$this->_setPath('view', TUIYO_PLUGINS.DS.'readernaut'.DS.'views');
		$this->addModelPath(TUIYO_PLUGINS.DS.'readernaut'.DS.'models');
	...
	public function remove(){
		...
		$model		= &$this->getModel("readernaut" );
		$view		= &$this->getView("readernaut", "json");
		...
		if($model->removeService( "readernaut", $user->id) ){
	 		$resp = array(
				"code" 	=> TUIYO_OK, 
				"error" => null, 
	 		);
