 ...
 */
class OrkutServiceController Extends TuiyoControllerServices{
	
	public function __construct(){
		
		//SET MODEL/VIEW PATH
		$this->_setPath('view', TUIYO_PLUGINS.DS.'orkut'.DS.'views');
		$this->addModelPath(TUIYO_PLUGINS.DS.'orkut'.DS.'models');
	...
	public function remove(){
		...
		$model		= &$this->getModel("orkut" );
		$view		= &$this->getView("orkut", "json");
		...
		if($model->removeService( "orkut", $user->id) ){
	 		$resp = array(
				"code" 	=> TUIYO_OK, 
				"error" => null, 
	 		);
