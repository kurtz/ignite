 ...
 */
class ViddlerServiceController Extends TuiyoControllerServices{
	
	public function __construct(){
		
		//SET MODEL/VIEW PATH
		$this->_setPath('view', TUIYO_PLUGINS.DS.'viddler'.DS.'views');
		$this->addModelPath(TUIYO_PLUGINS.DS.'viddler'.DS.'models');
	...
	public function remove(){
		...
		$model		= &$this->getModel("viddler" );
		$view		= &$this->getView("viddler", "json");
		...
		if($model->removeService( "viddler", $user->id) ){
	 		$resp = array(
				"code" 	=> TUIYO_OK, 
				"error" => null, 
	 		);
