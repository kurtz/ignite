...
/**
 * 
 * Messegner Controller.
 * @author livingstonefultang
 */
class MessengerServiceController Extends TuiyoControllerServices{
	
public function __construct(){
		
		//SET MODEL/VIEW PATH
		$this->_setPath('view', TUIYO_PLUGINS.DS.'messenger'.DS.'views');
		$this->addModelPath(TUIYO_PLUGINS.DS.'messenger'.DS.'models');
	...
	public function remove(){
		...
		$model		= &$this->getModel("messenger" );
		$view		= &$this->getView("messenger", "json");
		...
		if($model->removeService( "messenger", $user->id) ){
	 		$resp = array(
				"code" 	=> TUIYO_OK, 
				"error" => null, 
	 		);
