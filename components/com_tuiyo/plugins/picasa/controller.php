 ...
 */
class PicasaServiceController Extends TuiyoControllerServices{
	
	public function __construct(){
		
		//SET MODEL/VIEW PATH
		$this->_setPath('view', TUIYO_PLUGINS.DS.'picasa'.DS.'views');
		$this->addModelPath(TUIYO_PLUGINS.DS.'picasa'.DS.'models');
	...
	public function remove(){
		...
		$model		= &$this->getModel("picasa" );
		$view		= &$this->getView("picasa", "json");
		...
		if($model->removeService( "picasa", $user->id) ){
	 		$resp = array(
				"code" 	=> TUIYO_OK, 
				"error" => null, 
	 		);
