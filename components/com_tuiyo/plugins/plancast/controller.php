 ...
 */
class PlancastServiceController Extends TuiyoControllerServices{
	
	public function __construct(){
		
		//SET MODEL/VIEW PATH
		$this->_setPath('view', TUIYO_PLUGINS.DS.'plancast'.DS.'views');
		$this->addModelPath(TUIYO_PLUGINS.DS.'plancast'.DS.'models');
	...
	public function remove(){
		...
		$model		= &$this->getModel("plancast" );
		$view		= &$this->getView("plancast", "json");
		...
		if($model->removeService( "plancast", $user->id) ){
	 		$resp = array(
				"code" 	=> TUIYO_OK, 
				"error" => null, 
	 		);
