 ...
 */
class LastFmServiceController Extends TuiyoControllerServices{
	
	public function __construct(){
		
		//SET MODEL/VIEW PATH
		$this->_setPath('view', TUIYO_PLUGINS.DS.'lastfm'.DS.'views');
		$this->addModelPath(TUIYO_PLUGINS.DS.'lastfm'.DS.'models');
	...
	public function remove(){
		...
		if($model->removeService( "lastfm", $user->id) ){
	 		$resp = array(
				"code" 	=> TUIYO_OK, 
				"error" => null, 
	 		);
