 ...
 */
class BrightkiteServiceController Extends TuiyoControllerServices{
	
	public function __construct(){
		
		//SET MODEL/VIEW PATH
		$this->_setPath('view', TUIYO_PLUGINS.DS.'brightkite'.DS.'views');
		$this->addModelPath(TUIYO_PLUGINS.DS.'brightkite'.DS.'models');
	...
	public function remove(){
		...
		$model		= &$this->getModel("brightkite" );
		$view		= &$this->getView("brightkite", "json");
		...
		if($model->removeService( "brightkite", $user->id) ){
	 		$resp = array(
				"code" 	=> TUIYO_OK, 
				"error" => null, 
	 		);
