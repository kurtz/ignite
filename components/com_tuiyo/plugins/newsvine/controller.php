 ...
 */
class NewsvineServiceController Extends TuiyoControllerServices{
	
	public function __construct(){
		
		//SET MODEL/VIEW PATH
		$this->_setPath('view', TUIYO_PLUGINS.DS.'newsvine'.DS.'views');
		$this->addModelPath(TUIYO_PLUGINS.DS.'newsvine'.DS.'models');
	...
	public function remove(){
		...
		$model		= &$this->getModel("newsvine" );
		$view		= &$this->getView("newsvine", "json");
		...
		if($model->removeService( "newsvine", $user->id) ){
	 		$resp = array(
				"code" 	=> TUIYO_OK, 
				"error" => null, 
	 		);
