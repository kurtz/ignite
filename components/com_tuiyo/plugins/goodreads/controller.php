...
/**
 * 
 * Goodreads Controller.
 * @author livingstonefultang
 */
class GoodreadsServiceController Extends TuiyoControllerServices{
	
	public function __construct(){
		
		//SET MODEL/VIEW PATH
		$this->_setPath('view', TUIYO_PLUGINS.DS.'goodreads'.DS.'views');
		$this->addModelPath(TUIYO_PLUGINS.DS.'goodreads'.DS.'models');
	...
	public function remove(){
		...
		$model		= &$this->getModel("goodreads" );
		$view		= &$this->getView("goodreads", "json");
		...
		if($model->removeService( "goodreads", $user->id) ){
	 		$resp = array(
				"code" 	=> TUIYO_OK, 
				"error" => null, 
	 		);
