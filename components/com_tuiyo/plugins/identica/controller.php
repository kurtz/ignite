 ...
 */
class IdenticaServiceController Extends TuiyoControllerServices{
	
	public function __construct(){
		
		//SET MODEL/VIEW PATH
		$this->_setPath('view', TUIYO_PLUGINS.DS.'identica'.DS.'views');
		$this->addModelPath(TUIYO_PLUGINS.DS.'identica'.DS.'models');
	...
	public function remove(){
		...
		$model		= &$this->getModel("identica" );
		$view		= &$this->getView("identica", "json");
		...
		if($model->removeService( "identica", $user->id) ){
	 		$resp = array(
				"code" 	=> TUIYO_OK, 
				"error" => null, 
	 		);
