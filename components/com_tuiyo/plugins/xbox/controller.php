 ...
 */
class xBoxServiceController Extends TuiyoControllerServices{
	
	public function __construct(){
		
		//SET MODEL/VIEW PATH
		$this->_setPath('view', TUIYO_PLUGINS.DS.'xbox'.DS.'views');
		$this->addModelPath(TUIYO_PLUGINS.DS.'xbox'.DS.'models');
	...
	public function remove(){
		...
		$model		= &$this->getModel("xbox" );
		$view		= &$this->getView("xbox", "json");
		...
		if($model->removeService( "xbox", $user->id) ){
	 		$resp = array(
				"code" 	=> TUIYO_OK, 
				"error" => null, 
	 		);
