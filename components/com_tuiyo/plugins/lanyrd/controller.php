 ...
 */
class LanyrdServiceController Extends TuiyoControllerServices{
	
	public function __construct(){
		
		//SET MODEL/VIEW PATH
		$this->_setPath('view', TUIYO_PLUGINS.DS.'lanyrd'.DS.'views');
		$this->addModelPath(TUIYO_PLUGINS.DS.'lanyrd'.DS.'models');
	...
	public function remove(){
		...
		$model		= &$this->getModel("lanyrd" );
		$view		= &$this->getView("lanyrd", "json");
		...
		if($model->removeService( "lanyrd", $user->id) ){
	 		$resp = array(
				"code" 	=> TUIYO_OK, 
				"error" => null, 
	 		);
