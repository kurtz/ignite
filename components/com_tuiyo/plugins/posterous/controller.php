...
/**
 * 
 * Posterious Controller.
 * @author livingstonefultang
 */
class PosterousServiceController Extends TuiyoControllerServices{
	
	public function __construct(){
		
		//SET MODEL/VIEW PATH
		$this->_setPath('view', TUIYO_PLUGINS.DS.'posterous'.DS.'views');
		$this->addModelPath(TUIYO_PLUGINS.DS.'posterous'.DS.'models');
	...
	public function remove(){
		...
		$model		= &$this->getModel("posterous" );
		$view		= &$this->getView("posterous", "json");
		...
		if($model->removeService( "posterous", $user->id) ){
	 		$resp = array(
				"code" 	=> TUIYO_OK, 
				"error" => null, 
	 		);
