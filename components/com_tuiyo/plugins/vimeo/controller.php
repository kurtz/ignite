 ...
 */
class VimeoServiceController Extends TuiyoControllerServices{
	
public function __construct(){
		
		//SET MODEL/VIEW PATH
		$this->_setPath('view', TUIYO_PLUGINS.DS.'vimeo'.DS.'views');
		$this->addModelPath(TUIYO_PLUGINS.DS.'vimeo'.DS.'models');
	...
	public function remove(){
		...
		$model		= &$this->getModel("vimeo" );
		$view		= &$this->getView("vimeo", "json");
		...
		if($model->removeService( "vimeo", $user->id) ){
	 		$resp = array(
				"code" 	=> TUIYO_OK, 
				"error" => null, 
	 		);
