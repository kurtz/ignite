 ...
 */
class DopplrServiceController Extends TuiyoControllerServices{
	
	public function __construct(){
		
		//SET MODEL/VIEW PATH
		$this->_setPath('view', TUIYO_PLUGINS.DS.'dopplr'.DS.'views');
		$this->addModelPath(TUIYO_PLUGINS.DS.'dopplr'.DS.'models');
	...
	public function remove(){
		...
		$model		= &$this->getModel("dopplr" );
		$view		= &$this->getView("dopplr", "json");
		...
		if($model->removeService( "dopplr", $user->id) ){
	 		$resp = array(
				"code" 	=> TUIYO_OK, 
				"error" => null, 
	 		);
