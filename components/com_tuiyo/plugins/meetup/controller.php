 ...
 */
class MeetUpServiceController Extends TuiyoControllerServices{
	
	public function __construct(){
		
		//SET MODEL/VIEW PATH
		$this->_setPath('view', TUIYO_PLUGINS.DS.'meetup'.DS.'views');
		$this->addModelPath(TUIYO_PLUGINS.DS.'meetup'.DS.'models');
	...
	public function remove(){
		...
		$model		= &$this->getModel("meetup" );
		$view		= &$this->getView("meetup", "json");
		...
		if($model->removeService( "meetup", $user->id) ){
	 		$resp = array(
				"code" 	=> TUIYO_OK, 
				"error" => null, 
	 		);
