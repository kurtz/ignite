...
/**
 * 
 * Technorati Controller.
 * @author livingstonefultang
 */
class TechnoratiServiceController Extends TuiyoControllerServices{
	
	public function __construct(){
		
		//SET MODEL/VIEW PATH
		$this->_setPath('view', TUIYO_PLUGINS.DS.'technorati'.DS.'views');
		$this->addModelPath(TUIYO_PLUGINS.DS.'technorati'.DS.'models');
	...
	public function remove(){
		...
		$model		= &$this->getModel("technorati" );
		$view		= &$this->getView("technorati", "json");
		...
		if($model->removeService( "technorati", $user->id) ){
	 		$resp = array(
				"code" 	=> TUIYO_OK, 
				"error" => null, 
	 		);
