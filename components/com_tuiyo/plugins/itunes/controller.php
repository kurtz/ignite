 ...
 */
class iTunesServiceController Extends TuiyoControllerServices{
	
	public function __construct(){
		
		//SET MODEL/VIEW PATH
		$this->_setPath('view', TUIYO_PLUGINS.DS.'itunes'.DS.'views');
		$this->addModelPath(TUIYO_PLUGINS.DS.'itunes'.DS.'models');
	...
	public function remove(){
		...
		$model		= &$this->getModel("itunes" );
		$view		= &$this->getView("itunes", "json");
		...
		if($model->removeService( "itunes", $user->id) ){
	 		$resp = array(
				"code" 	=> TUIYO_OK, 
				"error" => null, 
	 		);
