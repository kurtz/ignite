...
/**
 * 
 * StumbleUpon Controller.
 * @author livingstonefultang
 */
class StumbleUponServiceController Extends TuiyoControllerServices{
	
	public function __construct(){
		
		//SET MODEL/VIEW PATH
		$this->_setPath('view', TUIYO_PLUGINS.DS.'stumbleupon'.DS.'views');
		$this->addModelPath(TUIYO_PLUGINS.DS.'stumbleupon'.DS.'models');
	...
	public function remove(){
		...
		$model		= &$this->getModel("stumbleupon" );
		$view		= &$this->getView("stumbleupon", "json");
		...
		if($model->removeService( "stumbleupon", $user->id) ){
	 		$resp = array(
				"code" 	=> TUIYO_OK, 
				"error" => null, 
	 		);
