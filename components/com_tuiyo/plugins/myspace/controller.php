 ...
 */
class MySpaceServiceController Extends TuiyoControllerServices{
	
	public function __construct(){
		
		//SET MODEL/VIEW PATH
		$this->_setPath('view', TUIYO_PLUGINS.DS.'myspace'.DS.'views');
		$this->addModelPath(TUIYO_PLUGINS.DS.'myspace'.DS.'models');
	...
	public function remove(){
		...
		$model		= &$this->getModel("myspace" );
		$view		= &$this->getView("myspace", "json");
		...
		if($model->removeService( "myspace", $user->id) ){
	 		$resp = array(
				"code" 	=> TUIYO_OK, 
				"error" => null, 
	 		);
