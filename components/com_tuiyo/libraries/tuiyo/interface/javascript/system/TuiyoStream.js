(function ($) {
    var TuiyoStream = function () {
        ...
        defaults = {
            ...
            newActivityTmpl = function (activity) {
                return $('<div class="tuiyoTable activityStreamItem activityItem" style="position:relative" ></div>').attr("id", "s" + activity.id).appendDom([{
                    tagName: 'div',
                    className: 'tuiyoTableRow',
                    childNodes: [

                    {
                        tagName: 'div',
                        className: 'tuiyoTableCell col1img',
                        style: 'width:10%;',
                        childNodes: [

                        {
                            tagName: 'div',
                            className: 'activityStreamItemUserImage48',
                            childNodes: [
                    ...
                    {
                        tagName: 'div',
                        className: 'tuiyoTableCell col2body',
                        style: 'width: 90%',
                        childNodes: [

                        {
                            tagName: 'div',
                            className: 'activityStreamItemActivityBody',
                            childNodes: [

                            {
                                tagName: 'div',
                                className: 'activityStreamItemTools',
                                align: 'center',
                                childNodes: [

                                {
                                    ...
                                    click: function (e) {
                                        ...
                                        $.post('index.php?option=com_tuiyo&' + $("meta[name=_token]").attr("content") + '=1', {
                                            ...
                                            $(divBox).appendDom(voterLinks([{
                                                "userID": inResponse.userID,
                                                "userPic": inResponse.userPic
                                            }], activity.id));
                                        }, 'json');
                                    }
                                },
                                ...
                                {
                                    tagName: 'a',
                                    className: 'voteDisLike',
                                    href: '#',
                                    style: '',
                                    innerHTML: $.gt.gettext(' dislike '),
                                    click: function (e) {
                                        e.preventDefault();
                                        var self = $(this);
                                        var token = $("meta[name=_token]").attr("content");
...

                                {
                                    ...
                                    click: function (c) {
                                        ...
                                        $($('<div class="stupidInternetExplorer"></div>').appendDom([{
                                            tagName: 'div',
                                            className: 'commenterDiv',
                                            childNodes: [

                                            {
                                                tagName: 'form',
                                                name: 'commentForm' + activity.id,
                                                id: 'commentForm' + activity.id,
                                                action: 'index.php',
                                                method: 'post',
                                                className: 'TuiyoForm commentForm',
                                                submit: function (s) {
                                                    s.preventDefault();
                                                    var text = $('#commentTextArea' + activity.id).val();
                                                    if (text.length < 1) return;
                                                    $.post('index.php?option=com_tuiyo', $('#commentForm' + activity.id).serialize(), function (inResponse) {
                                                        ...
                                                        $(newCommentTmpl({
                                                            ...
                                                            canDelete: true,
                                                            canComment: true
                                                        })).hide().appendTo($($("#s" + activity.id).find("div[class=activityStreamItemComments]"))).fadeIn("fast");
...

                                                {
                                                    ...
                                                    type: 'hidden',
                                                    value: '1',
                                                    name: $('meta[name=_token]').attr("content")
                                                },

                                                {
                                                    tagName: 'input',
                                                    type: 'hidden',
                                                    value: $.TuiyoDefines.get('userid'),
                                                    name: 'userid'
                                                },
...

                                                {
...

                                                    {
                                                        ...
                                                        {
                                                            tagName: 'div',
                                                            className: 'tuiyoTableCell',
                                                            style: 'width: 91%',
                                                            childNodes: [

                                                            {
                                                                tagName: 'textarea',
                                                                id: 'commentTextArea' + activity.id,
                                                                className: 'TuiyoFormTexArea commentTextArea',
                                                                name: 'commentbody',
                            ...
                            {
                                tagName: 'div',
                                className: 'activityBodyText',
                                innerHTML: activity.bodytext
                            },
                            ...
                            {
                                tagName: 'div',
                                className: 'bodyDescr' + ((activity.isPublic > 0) ? ' public ' : ' private '),
                                title: ((activity.isPublic > 0) ? $.gt.gettext('This entry is Public') : $.gt.gettext('This entry is Private')),
                                childNodes: [
                                ...
                                {
                                    tagName: 'a',
                                    href: $.TuiyoDefines.get("profilelink") + '&user=' + activity.username,
                                    innerHTML: '<span>' + activity.username + ' </span>'
                                },

                                {
                                    tagName: 'a',
                                    className: 'statustime',
                                    href: $.TuiyoDefines.get("statuslink") + '&user=' + activity.username + '&id=' + activity.id,
                                    innerHTML: '<span>' + activity.datetime + ' </span>'
                                },

                                {
                                    ...
                                    className: 'votes',
                                    href: '#',
                                    innerHTML: ((activity.likes.length > 0) ? '<span style="color: green" class="dolike">' + activity.likes.length + ' </span>' : '') + ((activity.dislikes.length > 0) ? ' <span style="color:red;" class="dontlike">' + activity.dislikes.length + '</span>' : ''),
                                    click: function (e) {
                                        e.preventDefault();
                                        ...
                                        $($('<div class="activityStreamItemVotes tuiyoTable"></div>').appendDom([{
                                            ...
                                            {
                                                tagName: 'div',
                                                className: 'tuiyoTableCell likes',
                                                title: $.gt.gettext('Likes this item'),
                                                style: 'width: 49%; margin-right: 1px; padding: 1px; background: #E6F9E0 none no-repeat scroll 0 0',
                                                childNodes: voterLinks(activity.likes, activity.id)
                                            },

                                            {
                                                tagName: 'div',
                                                className: 'tuiyoTableCell dlikes',
                                                title: $.gt.gettext('Dislikes this item'),
                                                style: 'width: 49%; background: #FFE8E8 none no-repeat scroll 0 0;  padding: 2px;',
                                                childNodes: voterLinks(activity.dislikes, activity.id)
                                            },
                            ...
                            tagName: 'div',
                            className: 'activityStreamItemComments',
                            innerHTML: ''
                        }]
                    }, {
                        tagName: 'div',
            ...
            commentFormTmpl = function (status) {
                var tmpl = [{
                    ...
                    {
                        tagName: 'form',
                        name: 'commentForm' + status.statusID,
                        id: 'commentForm' + status.statusID,
                        action: 'index.php',
                        method: 'post',
                        className: 'TuiyoForm commentForm',
                        submit: function (s) {
                            ...
                            if (text.length < 1) return;
                            $.post('index.php?option=com_tuiyo', $('#commentForm' + status.statusID).serialize(), function (inResponse) {
                                var text = findLinks(inResponse.data.status);
                                text = findMentions(text);
                                text = findSearchLinks(text);
                                ...
                                $(newCommentTmpl({
                                    ...
                                    canDelete: true,
                                    canComment: true
                                })).hide().appendTo($($("#s" + status.statusID).find("div[class=activityStreamItemComments]"))).fadeIn("fast");
                            }, 'json');
...

                        {
...

                            {
...

                                {
                                    ...
                                    {
                                        tagName: 'textarea',
                                        id: 'commentTextArea' + status.statusID,
                                        className: 'TuiyoFormTexArea commentTextArea',
                                        name: 'commentbody',
                                        style: 'max-height: 40px !important',
                                        keyup: function () {
            ...
            newCommentTmpl = function (comment) {
                return $('<div class="acitivtyStreamItemComment" ></div>').attr("id", "c" + comment.statusID).appendDom([{
...

                    {
                        ...
                        {
                            tagName: 'div',
                            className: 'activityStreamItemUserImage36',
                            childNodes: [
...

                    {
...

                        {
                            ...
                            innerHTML: '<strong><a href="' + $.TuiyoDefines.get("profilelink") + '&user=' + comment.username + '">' + comment.username + '</a> ' + comment.statusTime + '</strong> : ' + comment.bodyText
                        }]
                    },
            ...
            newStatusTmpl = function (status) {
                ...
                return $('<div class="tuiyoTable activityStreamItem ' + status.data.source + ' ' + status.data.itemType + '" style="position:relative">').attr("id", "s" + status.statusID).appendDom([{
...

                    {
                        ...
                        {
                            tagName: 'div',
                            className: 'activityStreamItemMainBody',
                            childNodes: [

                            {
                                ...
                                tagName: 'div',
                                className: 'bodyText',
                                innerHTML: status.bodyText
                            }, {
                                tagName: 'div',
                                className: 'bodyAttachmentPlaceHolder',
                                style: "display: none; cursor: pointer",
                                innerHTML: $.gt.gettext('view attachement')
                            }, {
                                tagName: 'div',
                                className: 'bodyDescr' + ((status.data.isPublic > 0) ? ' public ' : ' private '),
                                title: ((status.data.isPublic > 0) ? $.gt.gettext('This entry is Public') : $.gt.gettext('This entry is Private')),
                                childNodes: [
                                ...
                                {
                                    tagName: 'a',
                                    href: $.TuiyoDefines.get("profilelink") + '&user=' + status.username,
                                    innerHTML: '<span>' + status.username + ' </span>'
                                },

                                {
                                    tagName: 'a',
                                    className: 'statustime',
                                    href: $.TuiyoDefines.get("statuslink") + '&user=' + status.username + '&id=' + status.statusID,
                                    innerHTML: '<span>' + status.statusTime + ' </span>'
                                },

                                {
                                    ...
                                    className: 'votes',
                                    href: '#',
                                    innerHTML: ((status.likes.length > 0) ? '<span style="color: green" class="dolike"> ' + status.likes.length + '</span>' : ' ') + ((status.dislikes.length > 0) ? ' <span style="color:red;" class="dontlike">' + status.dislikes.length + '</span>' : ''),
                                    click: function (e) {
                                        e.preventDefault();
                                        ...
                                        $($('<div class="activityStreamItemVotes tuiyoTable"></div>').appendDom([{
...

                                            {
                                                ...
                                                title: $.gt.gettext('Likes this item'),
                                                style: 'width: 49%; margin-right: 1px; padding: 1px; background: #E6F9E0 none no-repeat scroll 0 0',
                                                childNodes: voterLinks(status.likes, status.statusID)
                                            },

                                            {
                                                ...
                                                title: $.gt.gettext('Dislikes this item'),
                                                style: 'width: 49%; background: #FFE8E8 none no-repeat scroll 0 0;  padding: 2px;',
                                                childNodes: voterLinks(status.dislikes, status.statusID)
                                            },
            ...
            voterLinks = function (users, statusID) {
                ...
                for (i = 0; i < users.length; i++) {
                    voterImgs[i] = {
                        tagName: 'div',
                        style: '; float:left;width: 38px; height: 38px',
                        childNodes: [

                        {
                            tagName: 'a',
                            href: $.TuiyoDefines.get('profilelink') + '&pid=' + users[i].userID,
                            childNodes: [
                    ...
                    if (parseInt(users[i].userID) === parseInt($.TuiyoDefines.get("userid"))) {
                        voterImgs[i].childNodes[voterImgs[i].childNodes.length] = {
                            tagName: 'a',
                            href: '#',
                            className: 'deleteVoteIcon',
                            innerHTML: 'del',
                            title: $.gt.gettext('delete your vote'),
                            click: function (e) {
                                var self = $(this);
                                var token = $("meta[name=_token]").attr("content");
                                e.preventDefault();
            ...
            runPlugin = function (plugin) {
                ...
                $("#TuiyoStreamUpdate").trigger(plugin);
                return false;
            },
        ...
        getProviderLink = function (text) {
            ...
            if (linked) {
                if (linked.length > 0) {
                    if ($.fn.oembed.isAvailable(linked[0])) {
                        return linked[0];
                    } else {
                        return null;
                    }
            ...
            if (textLength > limit) {
                $('#' + textFieldId).val(text.substr(0, limit));
                return false;
            } else {
                $('#' + infoBox).val((limit - textLength));
                return true;
            }
        };
        return {
            ...
            load: function (opt) {
                    ...
                    if (settings.loadInterval < 1) {
                        ...
                        if (settings.sinceID > 0) {
                            ...
                            intervalCounter = setInterval(function () {
                                TuiyoStream.load(settings)
                            }, settings.loadInterval * 1000)
                        }
                    }
                }
                ...
                $.getJSON( getTimelineURL, {
                    ...
                    "limitstart": settings.limitstart,
                    "userID": (!settings.userID) ? $.TuiyoDefines.get('userid') : settings.userID,
                    "format": "json"
                }, function (inResponse) {
                    //$("#ptext").val("");
                    $("#psubmit").attr('disabled', true);
                    ...
                    if (inResponse.data.length > 0) {
                        ...
                        $.each(inResponse.data, function (i, story) {
                            ...
                            if (story.itemType === "activity") {
                                ...
                                var activityContent = $(newActivityTmpl(story)).hide();
                                
                                if(settings.realTime){
                                    $(activityContent).prependTo("#userActivityStream").show();
                                }else{
                                     $(activityContent).appendTo("#userActivityStream").show();
                                }
                                
                                if (provider) {
                                    $('<div><img src="components/com_tuiyo/client/default/images/loading.gif"  /></div>').addClass("bodyAttachment").hide().insertBefore($("div#s" + story.id).find("a[rel=embedPlaceHolder]"));
                                ...
                                //Continue
                                var statusContent = $(newStatusTmpl({
                                    bodyText: text,
                                ...
                                if(settings.realTime){
                                    $(statusContent).prependTo("#userActivityStream").show();
                                }else{
                                     $(statusContent).appendTo("#userActivityStream").show();
                                }

                                if (provider) {

                                    $('<div></div>').addClass("bodyAttachment").hide().insertAfter($("div#s" + story.id).find("div.bodyAttachmentPlaceHolder"));
                            ...
                            if (!story.cancomment) $($("#s" + story.id).find("a[rel=ccomment]")).remove();
                            if (!story.cancomment) $($("#s" + story.id).find("a.repost")).remove();
                            ...
                            if (story.comments.length > 0) {
                                $.each(story.comments, function (i, comment) {
                                    ...
                                    })).hide().appendTo($($("#s" + comment.parentid).find("div[class=activityStreamItemComments]"))).show();
            ...
            init: function (opt) {
                ...
                $("a[rel=uploadFiles]").bind('click', function (e) {
                    ...
                    $.getScript($tuiyoAyncPath + 'swfupload.js', function () {
                        $.getScript($tuiyoAyncPath + 'asyncupload.js', function () {
                            $.getJSON($.TuiyoDefines.get("siteIndex") + '?' + $token + "=1", {
                                'option': 'com_tuiyo',
                                'do': 'getSessionId',
                ...
                $('div.timelineFilters').find('input[name=filterRadioGroup]').bind("change", function () {
                    var $value = $(this).val();
                    //alert( $value );
                    $(self).html('<img src="components/com_tuiyo/client/default/images/loading2.gif" style="margin-top: 8px" />');
                    $(self).TuiyoStreamLoad({
                        source: $value
                    });
                });
                            ...
                            $.each(data, function (i, suggested) {
                                $('<div class="listItem"></div>').appendDom([{
...

                                    {
                                        ...
                                        name: 'sharing[]',
                                        value: ((suggested.rType == 'friend') ? "p" : "g") + suggested.rID,
                                        click: function () {
                                            if (this.checked) {
                                                ...
                                                $('<span class="shareWith" rel="' + $(this).val() + '" title="' + suggested.rName + '"></span>').appendDom([{
                                                    tagName: 'a',
                                                    className: 'remove',
                                                    rel: 'removeParticipant',
                                                    innerHTML: suggested.rName,
                                                    click: function (e) {
                                                        e.preventDefault();
                                                        var self = $(this),
                ...
                if (settings.includefilters) {
                    ...
                    $("div#homepageActivityFeed").css({
                        "width": "70%",
                        "float": "left",
                        "margin-right": "15px"
                    }).addClass("tuiyoTableCell");
                    $('<div id="homepageFilterTabs" class="tuiyoTableCell" style="width: 25%; padding: 0 0 0 0 15px; float: left;">').appendDom([{
                        tagName: 'ul',
                        className: 'filterTabItems',
                        childNodes: [

                        {
                            tagName: 'li',
                            innerHTML: '<a>Posts mentioning me</a>'
                        },

                        {
                            tagName: 'li',
                            innerHTML: '<a>Post by me</a>'
                        },

                        {
                            tagName: 'li',
                            className: 'current',
                            innerHTML: '<a>Updates by Everyone</a>'
                        }, ]
                    },
                ...
                $("#" + settings.postFormId).submit(function (e) {
                    ...
                    if (!findCommand(text)) {
                        $("#psubmit").attr('disabled', true);
                        $.post($("#" + settings.postFormId).attr('action'), $("#" + settings.postFormId).serialize(), function (inResponse) {
                            ...
                            })).hide().prependTo(self).slideDown("fast");

                            settings.sinceID = inResponse.data.statusID;

                            $(self).find('div.TuiyoNotification').remove();
                            ...
                            if (provider) {
                                $('<div></div>').addClass("bodyAttachment").hide().insertAfter($("div#s" + inResponse.data.statusID).find("div.bodyAttachmentPlaceHolder"));
