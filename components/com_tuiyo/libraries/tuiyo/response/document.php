...
class TuiyoDocument extends TuiyoResponse {
     ...
     * @return
     */
    public function getElement($elementID = NULL) {/* Returns a php created element refer TuiyoElement, returns an element object */
    }
     ...
     * @return
     */
    public function createElement($elementID = NULL) { /* creates a new element object refer to TuiyoElement */
    }
     ...
     * @return
     */
    public function getWidget($widgetName) {/* gets an interface widget */
    }
